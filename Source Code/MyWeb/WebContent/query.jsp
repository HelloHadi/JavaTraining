...
<body>
  ...
  <%
  	  //registering the jdbc driver here, your string to use, here depends on what driver you are using.
	    Class.forName("com.mysql.jdbc.Driver");   
	    Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/ebookshop", "myuser", "p@@s"); // <== Check!
      // Connection conn =
